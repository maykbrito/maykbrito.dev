...
!((e, t) => {
  ...
  var e =
    ...
    t = e => 'IMG' === e.tagName,
    o = e => e && 1 === e.nodeType,
    n = e => '.svg' === (e.currentSrc || e.src).substr(-4).toLowerCase(),
    i = e => {
      try {
      ...
      var l =
        ...
        v = () => {
          for (var e = arguments.length, t = Array(e), o = 0; o < e; o++)
            t[o] = arguments[o]
          var n = t.reduce((e, t) => [].concat(e, i(t)), [])
          return (
            n
              .filter(e => -1 === x.indexOf(e))
              .forEach(e => {
        ...
        h = () => {
          for (var e = arguments.length, t = Array(e), o = 0; o < e; o++)
            t[o] = arguments[o]
          k.zoomed && E()
          var n = t.length > 0 ? t.reduce((e, t) => [].concat(e, i(t)), []) : x
          return (
            n.forEach(e => {
              ...
              if (k.zoomed) e(j)
                ...
                if (
                  ...
                  ;(k.zoomedHd = k.zoomed.cloneNode()),
                    k.zoomedHd.removeAttribute('sizes'),
                    k.zoomedHd.removeAttribute('loading')
                  var l = k.zoomedHd.addEventListener('load', () => {
